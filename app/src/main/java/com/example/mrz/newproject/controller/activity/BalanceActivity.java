...
//余额查询页面
public class BalanceActivity extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    private void intiDate() {
        SharedPreferences preferences=getSharedPreferences("userInfoData", Context.MODE_PRIVATE);
        mYhm = preferences.getString("userName","");
        mMima = preferences.getString("passWord","");
